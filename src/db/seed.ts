...
async function main() {
  ...
  await db.insert(places).values([
    ...
    { id: place.talbotCountyMd, slug: "talbot-county-maryland", name: "Talbot County, Maryland", nameJa: "タルボット郡(メリーランド州)", placeType: "region", country: "United States", latitude: 38.7896, longitude: -76.0716 },
    { id: place.adamsMa, slug: "adams-massachusetts", name: "Adams, Massachusetts", nameJa: "アダムズ(マサチューセッツ州)", placeType: "town", country: "United States", latitude: 42.6142, longitude: -73.1101 },
    { id: place.hollySpringsMs, slug: "holly-springs-mississippi", name: "Holly Springs, Mississippi", nameJa: "ホーリー・スプリングス(ミシシッピ州)", placeType: "town", country: "United States", latitude: 34.7679, longitude: -89.4487 },
    { id: place.calamba, slug: "calamba", name: "Calamba", nameJa: "カランバ", placeType: "town", country: "Philippines", latitude: 14.2117, longitude: 121.1652 },
    { id: place.oaxaca, slug: "oaxaca", name: "Oaxaca", nameJa: "オアハカ", placeType: "city", country: "Mexico", latitude: 17.0732, longitude: -96.7266 },
    { id: place.bordeaux, slug: "bordeaux", name: "Bordeaux", nameJa: "ボルドー", placeType: "city", country: "France", latitude: 44.8378, longitude: -0.5792 },
  ]);
  ...
  await db.insert(people).values([
    ...
    },
    {
      ...
      birthPlaceId: place.london,
      occupationsJson: JSON.stringify(["mathematician", "writer"]),
      occupationsJsonJa: JSON.stringify(["数学者", "著述家"]),
      nationalitiesJson: JSON.stringify(["British"]),
      biography:
        "Mathematician whose notes on Charles Babbage's Analytical Engine included what is now recognized as the first published algorithm intended for a machine.",
      biographyJa:
        "チャールズ・バベッジの解析機関に関する注釈の中で、機械のために書かれた世界初のアルゴリズムとされるものを発表した数学者。",
    },
    {
      id: person.fredericDouglass,
      slug: "frederick-douglass",
      name: "Frederick Douglass",
      nameJa: "フレデリック・ダグラス",
      birthDate: "1818-02-14",
      deathDate: "1895-02-20",
      birthPlaceId: place.talbotCountyMd,
      occupationsJson: JSON.stringify(["abolitionist", "writer", "orator"]),
      occupationsJsonJa: JSON.stringify(["奴隷制廃止運動家", "著述家", "演説家"]),
      nationalitiesJson: JSON.stringify(["American"]),
      biography:
        "Escaped slavery to become a leading abolitionist, orator, and writer, whose autobiographies remain among the most influential accounts of slavery in America.",
      biographyJa:
        "奴隷の身から逃れ、奴隷制廃止運動を率いる演説家・著述家となった。その自伝はアメリカにおける奴隷制の記録として今も高く評価されている。",
    },
    {
      id: person.susanBAnthony,
      slug: "susan-b-anthony",
      name: "Susan B. Anthony",
      nameJa: "スーザン・B・アンソニー",
      birthDate: "1820-02-15",
      deathDate: "1906-03-13",
      birthPlaceId: place.adamsMa,
      occupationsJson: JSON.stringify(["activist"]),
      occupationsJsonJa: JSON.stringify(["活動家"]),
      nationalitiesJson: JSON.stringify(["American"]),
      biography:
        "Suffragist who co-founded the National Woman Suffrage Association and campaigned for decades for women's right to vote, decades before it was won.",
      biographyJa:
        "全米女性参政権協会を共同設立し、女性参政権が実現するずっと前から数十年にわたり運動を率いた婦人参政権運動家。",
    },
    {
      id: person.idaBWells,
      slug: "ida-b-wells",
      ...
      deathDate: "1931-03-25",
      birthPlaceId: place.hollySpringsMs,
      occupationsJson: JSON.stringify(["journalist", "activist"]),
      occupationsJsonJa: JSON.stringify(["ジャーナリスト", "活動家"]),
      nationalitiesJson: JSON.stringify(["American"]),
      biography:
        "Investigative journalist who documented lynching in the American South and became a leading voice against racial violence and for civil rights.",
      biographyJa:
        "アメリカ南部におけるリンチの実態を調査報道し、人種暴力に反対する公民権運動の中心的な声となったジャーナリスト。",
    },
    {
      id: person.joseRizal,
      slug: "jose-rizal",
      ...
      birthPlaceId: place.calamba,
      occupationsJson: JSON.stringify(["writer", "reformist"]),
      occupationsJsonJa: JSON.stringify(["作家", "改革運動家"]),
      nationalitiesJson: JSON.stringify(["Filipino"]),
      biography:
        "Novelist and reformist whose writings criticizing Spanish colonial rule helped inspire the Philippine independence movement; executed by Spanish authorities in 1896.",
      biographyJa:
        "スペイン植民地支配を批判する小説を書き、フィリピン独立運動を鼓舞した作家・改革運動家。1896年、スペイン当局により処刑された。",
    },
    {
      id: person.cixi,
      ...
      nameJa: "西太后",
      birthDate: "1835-11-29",
      deathDate: "1908-11-15",
      birthPlaceId: place.beijing,
      occupationsJson: JSON.stringify(["ruler"]),
      occupationsJsonJa: JSON.stringify(["統治者"]),
      nationalitiesJson: JSON.stringify(["Chinese"]),
      biography:
        "De facto ruler of Qing China for nearly five decades, exercising power through regency over two child emperors during a period of foreign pressure and internal reform movements.",
      biographyJa:
        "約半世紀にわたり摂政として2代の幼帝を後見し、事実上の統治者として清朝を率いた。列強の圧力と国内改革運動が交錯する時代を通じて権力を握り続けた。",
    },
    {
      id: person.benitoJuarez,
      slug: "benito-juarez",
      name: "Benito Juárez",
      nameJa: "ベニート・フアレス",
      birthDate: "1806-03-21",
      deathDate: "1872-07-18",
      birthPlaceId: place.oaxaca,
      occupationsJson: JSON.stringify(["statesman"]),
      occupationsJsonJa: JSON.stringify(["政治家"]),
      nationalitiesJson: JSON.stringify(["Mexican"]),
      biography:
        "Zapotec lawyer who served as president of Mexico, leading the country through the War of Reform and resistance to French occupation while pursuing liberal reforms.",
      biographyJa:
        "サポテカ族出身の法律家としてメキシコ大統領を務め、改革戦争とフランス占領への抵抗を主導しながら自由主義改革を推し進めた。",
    },
    {
      id: person.rosaBonheur,
      slug: "rosa-bonheur",
      name: "Rosa Bonheur",
      nameJa: "ロサ・ボヌール",
      birthDate: "1822-03-16",
      deathDate: "1899-05-25",
      birthPlaceId: place.bordeaux,
      occupationsJson: JSON.stringify(["painter", "sculptor"]),
      occupationsJsonJa: JSON.stringify(["画家", "彫刻家"]),
      nationalitiesJson: JSON.stringify(["French"]),
      biography:
        "One of the most celebrated animal painters of her era, known for large-scale, meticulously observed works such as The Horse Fair; she obtained official permission to wear men's clothing to work at markets and slaughterhouses.",
      biographyJa:
        "『馬市』などの大作で知られる、当時最も名を馳せた動物画家の一人。市場や食肉処理場での取材のため、当局から男性服着用の許可を得ていたことでも知られる。",
    },
  ]);
  ...
  await db.insert(works).values([
    ...
    },
    {
      ...
      workTypeJa: "書籍",
      category: "ideas",
      creationStartDate: "1848-02-21",
      displayDate: "February 1848",
      datePrecision: "approximate",
      creationPlaceId: place.london,
      description:
        "A short pamphlet co-written with Friedrich Engels, laying out a theory of class struggle and history.",
      descriptionJa: "フリードリヒ・エンゲルスとの共著による小冊子で、階級闘争と歴史をめぐる理論を提示した。",
      confidence: "verified",
    },
    {
  ...
  await db.insert(workCreators).values([
    ...
    { workId: work.communistManifesto, personId: person.marx },
  ...
  await db.insert(imageAssets).values([
    ...
    // with the rights-pending placeholder rather than an image.
    {
      id: id(),
      entityType: "person",
      entityId: person.vanGogh,
      imageUrl: commonsFilePath("Vincent_van_Gogh_-_Self-Portrait_-_Google_Art_Project_(cropped).jpg", 400),
      sourceName: "Wikimedia Commons (Musée d'Orsay)",
      sourceRecordUrl:
        "https://commons.wikimedia.org/wiki/File:Vincent_van_Gogh_-_Self-Portrait_-_Google_Art_Project_(cropped).jpg",
      creator: "Vincent van Gogh",
      rightsStatement: "Public domain — author died more than 100 years ago",
      license: "PD-old-100-expired",
      publicDomain: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.einstein,
      imageUrl: commonsFilePath("Albert_Einstein_photo_1921.jpg", 400),
      sourceName: "Wikimedia Commons (Underwood & Underwood)",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Albert_Einstein_photo_1921.jpg",
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.darwin,
      imageUrl: commonsFilePath("Charles_Darwin_01.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Charles_Darwin_01.jpg",
      creator: "Unknown",
      rightsStatement: "Public Domain Mark",
      license: "PDM",
      publicDomain: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.gandhi,
      imageUrl: commonsFilePath("Mahatma-Gandhi,_studio,_1931.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Mahatma-Gandhi,_studio,_1931.jpg",
      creator: "Unknown",
      rightsStatement: "Public Domain Mark",
      license: "PDM",
      publicDomain: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.freud,
      imageUrl: commonsFilePath("Sigmund_Freud_1926.jpg", 400),
      sourceName: "Wikimedia Commons (Ferdinand Schmutzer)",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Sigmund_Freud_1926.jpg",
      creator: "Ferdinand Schmutzer",
      rightsStatement: "Public Domain Mark",
      license: "PDM",
      publicDomain: true,
      commercialUseAllowed: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.tolstoy,
      imageUrl: commonsFilePath("Leo_Tolstoy,_portrait.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Leo_Tolstoy,_portrait.jpg",
      creator: "Unknown",
      rightsStatement: "Public Domain Mark",
      license: "PDM",
      publicDomain: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.tesla,
      imageUrl: commonsFilePath("N.Tesla.JPG", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:N.Tesla.JPG",
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.pasteur,
      imageUrl: commonsFilePath("Louis_Pasteur.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Louis_Pasteur.jpg",
      creator: "Nadar",
      rightsStatement: "Public domain — author died more than 100 years ago",
      license: "PD-old-80-expired",
      publicDomain: true,
      commercialUseAllowed: true,
      derivativesAllowed: true,
      lastVerifiedAt: new Date().toISOString().slice(0, 10),
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.bell,
      imageUrl: commonsFilePath("Alexander_Graham_Bell.jpg", 400),
      sourceName: "Wikimedia Commons (Moffett Studio)",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Alexander_Graham_Bell.jpg",
      creator: "Moffett Studio",
      rightsStatement: "Public domain — published before 1931",
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.tagore,
      imageUrl: commonsFilePath("Rabindranath_Tagore_in_1909.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Rabindranath_Tagore_in_1909.jpg",
      creator: "Unknown",
      rightsStatement: "Public domain — published before 1931",
      license: "PD-US-expired",
      publicDomain: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.sunYatSen,
      imageUrl: commonsFilePath("Sun_Yat_Sen_portrait.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Sun_Yat_Sen_portrait.jpg",
      creator: "Unknown",
      rightsStatement: "Public domain in China — copyright expired",
      license: "PD-China-expired",
      publicDomain: true,
      commercialUseAllowed: true,
      derivativesAllowed: true,
      lastVerifiedAt: new Date().toISOString().slice(0, 10),
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.nightingale,
      imageUrl: commonsFilePath("Florence_Nightingale_(H_Hering_NPG_x82368).jpg", 400),
      sourceName: "Wikimedia Commons (National Portrait Gallery, London)",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Florence_Nightingale_(H_Hering_NPG_x82368).jpg",
      creator: "Henry Hering",
      rightsStatement: "Public Domain Mark",
      license: "PDM",
      publicDomain: true,
      commercialUseAllowed: true,
    ...
    },
    {
      id: id(),
      entityType: "person",
      entityId: person.tubman,
      imageUrl: commonsFilePath("Harriet_Tubman_portrait.jpg", 400),
      sourceName: "Wikimedia Commons",
      sourceRecordUrl: "https://commons.wikimedia.org/wiki/File:Harriet_Tubman_portrait.jpg",
      creator: "Unknown",
      rightsStatement: "Public domain — published before 1931",
      license: "PD-US-expired",
      publicDomain: true,
